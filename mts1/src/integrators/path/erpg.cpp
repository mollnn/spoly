...
class EnergyRedistributedPathGuiding : public MonteCarloIntegrator {
public:
    EnergyRedistributedPathGuiding(const Properties &props) : MonteCarloIntegrator(props) {
    ...
    */
    ...
    std::string toString() const {
        ...
        oss << "EnergyRedistributedPathGuiding[" << endl
...
MTS_IMPLEMENT_CLASS(EnergyRedistributedPathGuiding, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(EnergyRedistributedPathGuiding, "ERPG");
MTS_NAMESPACE_END
